...
import { useInternshipApplications } from "@/hooks/CompanyHook/useInternshipApplications";
...
export default function CompanyApplications() {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = useInternshipApplications(internshipId, page, size);
                ...
                <TableRow key={app.id}>
                  ...
                  <TableCell>
                    <div className="flex gap-2">
                      <a href={app.cvForm?.filePath} target="_blank">
