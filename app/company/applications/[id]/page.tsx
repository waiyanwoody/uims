      ...
      <div className="sticky top-0 z-20 border-b border-zinc-800 bg-black/60 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Badge className={application.status === 'REJECTED' ? "bg-red-500/20 text-red-400 border-red-500/50" : "bg-indigo-500 text-white"}>
              {application.status}
            </Badge>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto p-6 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-6">
              ...
              <div className="flex items-center justify-between relative px-4">
                {steps.map((step, index) => (
                  <div key={step} className="flex flex-col items-center z-10 gap-2">
                    ...
                    <span className={`text-[10px] font-bold uppercase tracking-tighter ${index <= currentStepIndex ? "text-indigo-400" : "text-zinc-600"}`}>
                      {step}
                    </span>
                  </div>
                ))}
                ...
                <div 
                  className="absolute top-5 left-0 h-[2px] bg-indigo-500 transition-all duration-700 -z-0" 
          ...
          <Card className="bg-zinc-900 border-zinc-800 overflow-hidden shadow-2xl">
            <div className="h-24 bg-gradient-to-r from-indigo-900 to-zinc-900" />
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2 pt-2">
                    <div className="flex items-center gap-3 text-sm text-zinc-300">
                      <Mail className="w-4 h-4 text-indigo-400" /> {application.student.email}
                    </div>
                ...
                <div className="bg-zinc-950/50 p-4 rounded-lg border border-zinc-800/50 space-y-3">
                  ...
                  <div className="space-y-1">
                    <p className="text-indigo-400 font-semibold">{application.internship.title}</p>
        ...
        <div className="lg:col-span-4 space-y-6">
              ...
              {application.status !== "APPROVED" && application.status !== "REJECTED" ? (
                <>
                  <Button 
                    ...
                    disabled={isUpdating}
                    className="w-full h-12 bg-indigo-600 hover:bg-indigo-500 text-white gap-2 shadow-[0_0_20px_rgba(79,70,229,0.3)] transition-all"
                  >
          ...
          <div className="p-4 rounded-xl border border-indigo-500/20 bg-indigo-500/5">
            <p className="text-[10px] font-bold text-indigo-400 uppercase mb-2">Internal Note</p>
