  ...
  return (
    <div className="p-6 md:p-8 space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-2">Manage your company account preferences</p>
      </div>
      ...
      <Card className="p-8 border border-border">
        ...
        <div className="space-y-4">
          {[
            ...
            { label: 'Weekly internship summary', value: true },
      ...
      <Card className="p-8 border border-border">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Button variant="outline" className="border-border bg-transparent">Manage Plan</Button>
          </div>
        </div>
      </Card>
